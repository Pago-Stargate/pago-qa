#!/usr/bin/env python3
"""Copy test cases from Bills SDK to Bills API in TestRail."""
...
def copy_case(case, new_section_id, is_bcr):
    """Copy a single case to a new section."""
    ...
    # Use template_id=2 (Steps) when steps_separated exists, else template_id=1 (Text)
    if steps_sep:
